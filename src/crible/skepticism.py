...
# Tiers that count as PROOF (genuine lived experience): forum/community posts
# (high) and marketplace / review-platform USER reviews (medium). Review blogs
# and unlisted pages (unknown) and explicit marketing/affiliate (low) are CONTEXT
# only — shown with their quotes, but they never earn a recommendation.
